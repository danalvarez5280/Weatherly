...
export default class App extends React.Component {
  ...
  weatherImage() {
    if (this.state.condition.includes('overcast')) {
      this.setState({
      weatherIcon: "/assets/storm" +"Icon.svg",
      mainIcon: "/assets/storm.svg",
      //BG color -- toggleClass
      })
    }
    // else if (string.includes("sun")) {
    //   //then setState weatherIcon to sun image
    //   //BG color -- toggleClass
    // } else if (string.includes("cloud")) {
    //   //then setState weatherIcon to cloud image
    //   //BG color -- toggleClass
    // }
  }
