...
export default class App extends React.Component {
  ...
  getWeatherInfo() {
    fetch(`http://api.wunderground.com/api/${key.weathergroundKey}/conditions/hourly/forecast10/q/Colorado/${this.state.city}.json`)
    .then(data => data.json())
    ...
    // high: data.forecast.simpleforecast.forecastday.high.fahrenheit,
    // low: data.forecast.simpleforecast.forecastday.low.fahrenheit
  }))
  }
